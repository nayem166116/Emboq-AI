...
const hero = heroStage({
  ...
  lede: 'Four verticals where perception failures are the most expensive \u2014 and where TTA Robotics is already in production.',
...
const p1a = "TTA Robotics watches fastening force curves and alignment tolerances cell-by-cell, flagging drift against the cell\u2019s own baseline rather than a fixed OEM spec.";
...
const p4a = "TTA Robotics\u2019s sensor-agnostic perception layer reads structural and hydraulic stress patterns from retrofit sensors, without requiring OEM-specific hardware.";
...
page({
  slug:'/use-cases',
  title:'Use cases \u2014 TTA Robotics in production',
  description:'How TTA Robotics is deployed across automotive assembly, warehousing, food & beverage, and heavy equipment yards.',
  hero, sheet,
