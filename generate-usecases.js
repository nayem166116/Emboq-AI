...
const hero = heroStage({
  ...
  lede: 'Four verticals where perception failures are the most expensive \u2014 and where Emboq AI is already in production.',
...
const p1a = "Emboq AI watches fastening force curves and alignment tolerances cell-by-cell, flagging drift against the cell\u2019s own baseline rather than a fixed OEM spec.";
...
const p4a = "Emboq AI\u2019s sensor-agnostic perception layer reads structural and hydraulic stress patterns from retrofit sensors, without requiring OEM-specific hardware.";
...
page({
  slug:'/use-cases',
  title:'Use cases \u2014 Emboq AI in production',
  description:'How Emboq AI is deployed across automotive assembly, warehousing, food & beverage, and heavy equipment yards.',
  hero, sheet,
