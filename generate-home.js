...
const hero = heroStage({
  ...
  lede: 'TTA Robotics gives robots, fixed automation, and inspection systems a shared perception and decision layer \u2014 so drift, wear, and risk get caught before they become downtime.',
...
<section class="section">
  ...
  ${mediaVideo({
    name:'stack',
    shape:'wide',
    caption:'Perception, prediction, and decision layers running together on a live cell.',
...
<section class="section">
  ...
  ${mediaVideo({
    ...
    <p class="lede" style="margin:20px auto 0;max-width:560px;">Every TTA Robotics deployment extends that line a little further \u2014 from a single cell, to a line, to a site, to a fleet.</p>`
  })}
  </div>
</section>
...
page({
  slug:'/',
  title:'TTA Robotics \u2014 Physical AI for industrial automation',
  description:'TTA Robotics gives industrial robots and fixed automation a shared perception and decision layer, catching drift, wear, and risk before it becomes downtime.',
  hero, sheet,
