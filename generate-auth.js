...
`;
page({ slug:'/register', title:'Create your account \u2014 Emboq AI', description:'Request access to Emboq AI.', hero:authHero('REGISTER','Create your account.'), sheet:registerSheet, finaleEyebrow:'EMBOQ AI', finaleText:'Welcome to the floor.', extraScripts:['/assets/js/auth.js'] });
...
`;
page({ slug:'/verify', title:'Verify your email \u2014 Emboq AI', description:'Verify your email to finish creating your Emboq AI account.', hero:authHero('VERIFY','Check your email.'), sheet:verifySheet, finaleEyebrow:'EMBOQ AI', finaleText:'One code away.', extraScripts:['/assets/js/auth.js'] });
  ...
  <div class="auth-grid">
    <div class="auth-card" data-reveal="rise">
      <form id="login-form" novalidate>
        ...
        <p class="hint" style="margin-top:20px;text-align:center;">New to Emboq AI? <a href="/register" style="color:var(--text-1);text-decoration:underline;">Request access</a></p>
      </form>
    </div>
    <div class="auth-aside" data-reveal="fade">
...
`;
page({ slug:'/login', title:'Sign in \u2014 Emboq AI', description:'Sign in to your Emboq AI account.', hero:authHero('LOGIN','Sign in.'), sheet:loginSheet, finaleEyebrow:'EMBOQ AI', finaleText:'Good to see you back.', extraScripts:['/assets/js/auth.js'] });
...
`;
page({ slug:'/forgot-password', title:'Reset your password \u2014 Emboq AI', description:'Reset your Emboq AI account password.', hero:authHero('ACCOUNT RECOVERY','Reset your password.'), sheet:forgotSheet, finaleEyebrow:'EMBOQ AI', finaleText:'Almost back in.', extraScripts:['/assets/js/auth.js'] });
...
`;
page({ slug:'/loading', title:'Emboq AI', description:'Preparing your workspace.', hero:heroStage({ eyebrow:'', heading:'', compact:true, heroVideo:'hero-auth' }), sheet:loadingSheet, finaleEyebrow:'', finaleText:'', bodyAttrs:'style="background:var(--bg)"' });
