...
`;
page({ slug:'/register', title:'Create your account \u2014 Opi Robotics', description:'Request access to Opi Robotics.', hero:authHero('REGISTER','Create your account.'), sheet:registerSheet, finaleEyebrow:'OPI ROBOTICS', finaleText:'Welcome to the floor.', extraScripts:['/assets/js/auth.js'] });
...
`;
page({ slug:'/verify', title:'Verify your email \u2014 Opi Robotics', description:'Verify your email to finish creating your Opi Robotics account.', hero:authHero('VERIFY','Check your email.'), sheet:verifySheet, finaleEyebrow:'OPI ROBOTICS', finaleText:'One code away.', extraScripts:['/assets/js/auth.js'] });
  ...
  <div class="auth-grid">
    <div class="auth-card" data-reveal="rise">
      <form id="login-form" novalidate>
        ...
        <p class="hint" style="margin-top:20px;text-align:center;">New to Opi Robotics? <a href="/register" style="color:var(--text-1);text-decoration:underline;">Request access</a></p>
      </form>
    </div>
    <div class="auth-aside" data-reveal="fade">
...
`;
page({ slug:'/login', title:'Sign in \u2014 Opi Robotics', description:'Sign in to your Opi Robotics account.', hero:authHero('LOGIN','Sign in.'), sheet:loginSheet, finaleEyebrow:'OPI ROBOTICS', finaleText:'Good to see you back.', extraScripts:['/assets/js/auth.js'] });
...
`;
page({ slug:'/forgot-password', title:'Reset your password \u2014 Opi Robotics', description:'Reset your Opi Robotics account password.', hero:authHero('ACCOUNT RECOVERY','Reset your password.'), sheet:forgotSheet, finaleEyebrow:'OPI ROBOTICS', finaleText:'Almost back in.', extraScripts:['/assets/js/auth.js'] });
...
`;
page({ slug:'/loading', title:'Opi Robotics', description:'Preparing your workspace.', hero:heroStage({ eyebrow:'', heading:'', compact:true, heroVideo:'hero-auth' }), sheet:loadingSheet, finaleEyebrow:'', finaleText:'', bodyAttrs:'style="background:var(--bg)"' });
