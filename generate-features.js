...
const hero = heroStage({
  ...
  lede: 'Opi Robotics is built as one continuous stack \u2014 not a dashboard bolted onto someone else\'s sensors.',
...
<section class="section">
  ...
  ${rowCard('03','Safety envelope enforcement','Defines physical and operational limits per cell; when perception detects a boundary risk, Opi Robotics can trigger a supervised hold before a person or part is at risk.')}
...
<section class="section">
  ...
  ${mediaVideo({
    ...
    <h3 style="margin-top:14px;font-size:clamp(1.5rem,1.2rem + 1.2vw,2.1rem);max-width:620px;">See the floor the way Opi Robotics sees it.</h3>
...
page({
  slug:'/features',
  title:'Features \u2014 Opi Robotics perception stack',
  description:'Perception fusion, predictive wear modeling, safety envelope enforcement, fleet-wide learning, and OT integrations \u2014 the full Opi Robotics stack.',
  hero, sheet,
