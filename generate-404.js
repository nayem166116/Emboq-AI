...
<html lang="en">
<head>
${headTags({ slug:'/404', title:'Page not found \u2014 Opi Robotics', description:'The page you are looking for does not exist.' })}
</head>
<body>
...
${finale('Even off the map, the horizon is still there.', 'OPI ROBOTICS')}
${footer()}
${cookieUI()}
${scripts()}
</body>
