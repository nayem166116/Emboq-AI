...
<html lang="en">
<head>
${headTags({ slug:'/404', title:'Page not found \u2014 Emboq AI', description:'The page you are looking for does not exist.' })}
</head>
<body>
...
${finale('Even off the map, the horizon is still there.', 'EMBOQ AI')}
${footer()}
${cookieUI()}
${scripts()}
</body>
