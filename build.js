// EMBOQ AI static site generator — authoring convenience only.
...
function wordmark(){
  return `<a href="/" class="wordmark" aria-label="Emboq AI home"><span class="wordmark__mark" aria-hidden="true"></span>Emboq AI</a>`;
}
...
<div class="nav-overlay" id="nav-overlay" aria-hidden="true">
  ...
  <div class="nav-overlay__foot">
    ...
    <a href="mailto:hello@emboq.ai" class="nav-foot__spacer">hello@emboq.ai</a>
  </div>
</div>`;
}
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-slab">EMBOQ</div>
    ...
    <div class="footer-bottom">
      <span>\u00a9 <span data-year></span> Emboq AI, Inc. All rights reserved.</span>
      <div class="footer-social">
        <a href="https://linkedin.com" aria-label="Emboq AI on LinkedIn" target="_blank" rel="noopener"><i class="fa-brands fa-linkedin"></i></a>
        <a href="https://x.com" aria-label="Emboq AI on X" target="_blank" rel="noopener"><i class="fa-brands fa-x-twitter"></i></a>
        <a href="https://github.com" aria-label="Emboq AI on GitHub" target="_blank" rel="noopener"><i class="fa-brands fa-github"></i></a>
      </div>
    </div>
  </div>
</footer>`;
...
<div class="cookie-banner" role="dialog" aria-label="Cookie preferences">
  <p>We use essential cookies to run Emboq AI, and optional analytics cookies to understand how the site is used. You can change this anytime in Cookie Settings.</p>
...
function headTags({ slug, title, description }){
  const url = 'https://emboq.ai' + (slug === '/' ? '' : slug);
...
<div class="finale">
  <div>
    <p class="eyebrow">${eyebrow || 'EMBOQ AI'}</p>
    <p>${text}</p>
  </div>
</div>`;
}
