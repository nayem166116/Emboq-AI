...
`;
  page({ slug, title, description, hero, sheet, finaleEyebrow:'TTA ROBOTICS', finaleText:'Questions about this policy? Write to privacy@ttarobotics.com.' });
}

legalPage({
  slug:'/privacy',
  title:'Privacy Policy \u2014 TTA Robotics',
  description:'How TTA Robotics collects, uses, and protects data across our website and industrial monitoring platform.',
  ...
  sections:[
    `<h2 id="scope">1. Scope</h2><p>This Privacy Policy describes how TTA Robotics LLC ("TTA Robotics", "we", "us"), an Illinois limited liability company (file number LLC_15352426) with its registered address at 1632 Todd Farm Drive, Elgin, IL 60123, United States, handles personal data collected through our marketing website (ttarobotics.com) and through our industrial monitoring platform when deployed at a customer site. It does not cover third-party sites we link to.</p>`,
    ...
    `<h2 id="sharing">5. Sharing & disclosure</h2><p>We share data with infrastructure and analytics subprocessors strictly to operate our services, under contractual confidentiality obligations. We disclose data when required by law, to enforce our agreements, or to protect the rights and safety of TTA Robotics, our customers, or the public.</p>`,
    `<h2 id="security">6. Security</h2><p>We use encryption in transit and at rest, role-based access controls, and audit logging on operational data. No system is perfectly secure, and we encourage you to report any suspected vulnerability to security@ttarobotics.com.</p>`,
    `<h2 id="your-rights">7. Your rights</h2><p>Depending on your location, you may have the right to access, correct, delete, or export your personal data, and to withdraw analytics/marketing consent at any time via Cookie Settings in our footer. To exercise these rights, contact privacy@ttarobotics.com; we will respond within 30 days.</p>`,
    `<h2 id="contact">8. Contact</h2><p>Questions about this policy can be sent to <a href="mailto:privacy@ttarobotics.com" style="text-decoration:underline;">privacy@ttarobotics.com</a>.</p>`,
  ]
});

legalPage({
  slug:'/terms',
  title:'Terms of Service \u2014 TTA Robotics',
  description:'The terms that govern use of the TTA Robotics website and platform.',
  ...
  sections:[
    `<h2 id="agreement">1. Agreement</h2><p>These Terms of Service are an agreement between you and TTA Robotics LLC, an Illinois limited liability company (file number LLC_15352426) registered at 1632 Todd Farm Drive, Elgin, IL 60123, United States, and they govern your use of the TTA Robotics website and, where applicable, our industrial monitoring platform. By creating an account or using our services, you agree to these terms. Enterprise customers with a signed order form are additionally governed by that agreement, which controls in the event of a conflict.</p>`,
    `<h2 id="accounts">2. Accounts</h2><p>You must provide accurate information when creating an account and are responsible for activity under your credentials. Notify us immediately at support@ttarobotics.com if you suspect unauthorized access.</p>`,
    ...
    `<h2 id="liability">6. Liability</h2><p>To the maximum extent permitted by law, TTA Robotics's aggregate liability arising from these terms is limited to the fees paid in the 12 months preceding the claim. Nothing in these terms limits liability that cannot be limited under applicable law.</p>`,
...
legalPage({
  slug:'/cookies',
  title:'Cookie Policy \u2014 TTA Robotics',
  description:'How TTA Robotics uses cookies on our website, and how to manage your preferences.',
