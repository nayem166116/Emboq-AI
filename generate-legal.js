...
`;
  page({ slug, title, description, hero, sheet, finaleEyebrow:'EMBOQ AI', finaleText:'Questions about this policy? Write to privacy@emboq.ai.' });
}

legalPage({
  slug:'/privacy',
  title:'Privacy Policy \u2014 Emboq AI',
  description:'How Emboq AI collects, uses, and protects data across our website and industrial monitoring platform.',
  ...
  sections:[
    `<h2 id="scope">1. Scope</h2><p>This Privacy Policy describes how Emboq AI, Inc. ("Emboq AI", "we", "us") handles personal data collected through our marketing website (emboq.ai) and through our industrial monitoring platform when deployed at a customer site. It does not cover third-party sites we link to.</p>`,
    ...
    `<h2 id="sharing">5. Sharing & disclosure</h2><p>We share data with infrastructure and analytics subprocessors strictly to operate our services, under contractual confidentiality obligations. We disclose data when required by law, to enforce our agreements, or to protect the rights and safety of Emboq AI, our customers, or the public.</p>`,
    `<h2 id="security">6. Security</h2><p>We use encryption in transit and at rest, role-based access controls, and audit logging on operational data. No system is perfectly secure, and we encourage you to report any suspected vulnerability to security@emboq.ai.</p>`,
    `<h2 id="your-rights">7. Your rights</h2><p>Depending on your location, you may have the right to access, correct, delete, or export your personal data, and to withdraw analytics/marketing consent at any time via Cookie Settings in our footer. To exercise these rights, contact privacy@emboq.ai; we will respond within 30 days.</p>`,
    `<h2 id="contact">8. Contact</h2><p>Questions about this policy can be sent to <a href="mailto:privacy@emboq.ai" style="text-decoration:underline;">privacy@emboq.ai</a>.</p>`,
  ]
});

legalPage({
  slug:'/terms',
  title:'Terms of Service \u2014 Emboq AI',
  description:'The terms that govern use of the Emboq AI website and platform.',
  ...
  sections:[
    `<h2 id="agreement">1. Agreement</h2><p>These Terms of Service govern your use of the Emboq AI website and, where applicable, our industrial monitoring platform. By creating an account or using our services, you agree to these terms. Enterprise customers with a signed order form are additionally governed by that agreement, which controls in the event of a conflict.</p>`,
    `<h2 id="accounts">2. Accounts</h2><p>You must provide accurate information when creating an account and are responsible for activity under your credentials. Notify us immediately at support@emboq.ai if you suspect unauthorized access.</p>`,
    ...
    `<h2 id="liability">6. Liability</h2><p>To the maximum extent permitted by law, Emboq AI's aggregate liability arising from these terms is limited to the fees paid in the 12 months preceding the claim. Nothing in these terms limits liability that cannot be limited under applicable law.</p>`,
...
legalPage({
  slug:'/cookies',
  title:'Cookie Policy \u2014 Emboq AI',
  description:'How Emboq AI uses cookies on our website, and how to manage your preferences.',
